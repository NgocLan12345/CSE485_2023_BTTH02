...
<body>
    ...
    <main class="container">
        <form action="" method="post"
            style="width: 50%; background: #3d456a2e; border: 1px solid; border-radius: 10px; margin: 50px auto; padding: 30px;">
            <h3 style="margin-bottom: 20px"> Bạn có muốn xóa bài viết này không ?</h3>
            <div>
